namespace eval ::optrace {
  variable script "D:/OneDrive_2025-04-23/RISCV CPU/project_1/project_1.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "create in-memory project" START { }
  ...
  set_property board_part_repo_paths {C:/Users/rda74/AppData/Roaming/Xilinx/Vivado/2024.2/xhub/board_store/xilinx_board_store} [current_project]
  set_property board_part avnet.com:zuboard_1cg:part0:1.0 [current_project]
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
OPTRACE "create in-memory project" END { }
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir {D:/OneDrive_2025-04-23/RISCV CPU/project_1/project_1.cache/wt} [current_project]
  set_property parent.project_path {D:/OneDrive_2025-04-23/RISCV CPU/project_1/project_1.xpr} [current_project]
  set_property ip_output_repo {{D:/OneDrive_2025-04-23/RISCV CPU/project_1/project_1.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet {{D:/OneDrive_2025-04-23/RISCV CPU/project_1/project_1.runs/synth_1/design_1_wrapper.dcp}}
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files {{D:/OneDrive_2025-04-23/RISCV CPU/project_1/project_1.srcs/sources_1/bd/design_1/design_1.bd}}
