...
HD_PWD='D:/OneDrive_2025-04-23/RISCV CPU/PotatoCPU/PotatoCPU.runs/aee_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aee_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aee_rom.tcl
