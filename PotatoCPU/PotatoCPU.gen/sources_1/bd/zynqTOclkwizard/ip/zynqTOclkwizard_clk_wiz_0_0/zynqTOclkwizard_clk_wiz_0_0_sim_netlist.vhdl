...
-- Command     : write_vhdl -force -mode funcsim -rename_top zynqTOclkwizard_clk_wiz_0_0 -prefix
--               zynqTOclkwizard_clk_wiz_0_0_ zynqTOclkwizard_clk_wiz_0_0_sim_netlist.vhdl
...
entity zynqTOclkwizard_clk_wiz_0_0_zynqTOclkwizard_clk_wiz_0_0_clk_wiz is
  port (
...
end zynqTOclkwizard_clk_wiz_0_0_zynqTOclkwizard_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of zynqTOclkwizard_clk_wiz_0_0_zynqTOclkwizard_clk_wiz_0_0_clk_wiz is
  signal clk_in1_zynqTOclkwizard_clk_wiz_0_0 : STD_LOGIC;
  signal reset_high : STD_LOGIC;
  signal system_clk_zynqTOclkwizard_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      ...
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_zynqTOclkwizard_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => system_clk_zynqTOclkwizard_clk_wiz_0_0,
      O => system_clk
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_zynqTOclkwizard_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => system_clk_zynqTOclkwizard_clk_wiz_0_0,
...
entity zynqTOclkwizard_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of zynqTOclkwizard_clk_wiz_0_0 : entity is true;
end zynqTOclkwizard_clk_wiz_0_0;

architecture STRUCTURE of zynqTOclkwizard_clk_wiz_0_0 is
begin
inst: entity work.zynqTOclkwizard_clk_wiz_0_0_zynqTOclkwizard_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      locked => locked,
      resetn => resetn,
